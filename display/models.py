...
class hostel(models.Model):
    ...
    hostel_state=models.CharField(max_length=30, default="")
    hostel_city=models.CharField(max_length=30, default="")
    hostel_area=models.CharField(max_length=120, default="")
    hostel_pincode=models.IntegerField(default="")
    hostel_address=models.CharField(max_length=120,default="")
    hostel_rent=models.IntegerField(default="")
    hostel_deposit=models.IntegerField(default="")
    hostel_contactnumber=models.IntegerField(default="")
    hostel_mess=models.IntegerField(default="")
    hostel_mealtype=models.CharField(max_length=120, default="")
    hostel_ac=models.IntegerField(default="")
    hostel_vistorentry=models.IntegerField(default="")
    hostel_watercooler=models.IntegerField(default="")
    hostel_roomcleaning=models.IntegerField(default="")  
