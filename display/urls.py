...
urlpatterns = [
	...
	path("rentalserviceprovider/",views.rentalserviceprovider,name="rentalserviceprovider"),
	path("tiffinserviceprovider/",views.tiffinserviceprovider,name="tiffinserviceprovider"),
	path("laundryserviceprovider/",views.laundryserviceprovider,name="laundryserviceprovider"),
	path("libraryserviceprovider/",views.libraryserviceprovider,name="libraryserviceprovider"),
